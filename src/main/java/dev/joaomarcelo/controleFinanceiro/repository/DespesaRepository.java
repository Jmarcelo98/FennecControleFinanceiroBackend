...
public interface DespesaRepository extends JpaRepository<Despesa, Integer> {
	...
	Optional<List<Despesa>> findByIdUsuarioMes(@Param("ano") Integer ano, @Param("mes") Integer mes,
			@Param("id") Integer id);
	...
	List<Double> valoresDespesaDataAtual(@Param("ano") Integer ano, @Param("mes") Integer mes,
			@Param("id") Integer id);
