...
public class TipoReceitaController {
	...
	@PutMapping
	public ResponseEntity<String> atualizarTipoDeReceita(@RequestBody @Valid TipoReceitaDTO tipoReceitaDTO) {
		
		return tipoReceitaService.atualizarTipoDeReceita(tipoReceitaDTO, idToken.pegarIdPeloToken());
